...
IL2CPP_EXTERN_C String_t* _stringLiteralAB3198624EE0C5EF940178C325E58FDC70E514F4;
...
{
	// UnityEngine.GameObject Cursor::cursorChildObject
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___cursorChildObject_4;
	// UnityEngine.GameObject Cursor::objectToPlane
	GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* ___objectToPlane_5;
	// UnityEngine.XR.ARFoundation.ARRaycastManager Cursor::raycastManager
	ARRaycastManager_tD9459374F0F5BD9E2E4A8A1C665E7F33F9C2EE44* ___raycastManager_6;
	// System.Boolean Cursor::useCursor
	bool ___useCursor_7;
};
...
// System.Void Cursor::UpdateCursor()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cursor_UpdateCursor_m277C7C0C38A8A6686B35AE442627A2A1434DD592 (Cursor_tFFE36C72C94876270A4C0D9401D8C069CEB28254* __this, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Cursor_Update_m65096EA179642423A14498C8DC2DAF2FA47A4C8A (Cursor_tFFE36C72C94876270A4C0D9401D8C069CEB28254* __this, const RuntimeMethod* method) 
{
	...
	{
		// UpdateCursor();
		Cursor_UpdateCursor_m277C7C0C38A8A6686B35AE442627A2A1434DD592(__this, NULL);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnableManager_Update_m7A9A38650830610C5C81A77D22ABB3A011E23220 (SpawnableManager_tC029DDD2FD6DB3F1396C3546F6F6A7F53A395730* __this, const RuntimeMethod* method) 
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralAB3198624EE0C5EF940178C325E58FDC70E514F4);
		s_Il2CppMethodInitialized = true;
	}
...
IL_0008:
	{
		...
		V_1 = L_5;
		// Debug.Log("WOW THIS IS WHAT YOU RE LOOKING FOR POG: "+m_RaycastManager.Raycast(Input.GetTouch(0).position, m_Hits));
		...
		V_3 = L_10;
		String_t* L_11;
		L_11 = Boolean_ToString_m6646C8026B1DF381A1EE8CD13549175E9703CC63((&V_3), NULL);
		String_t* L_12;
		L_12 = String_Concat_m9E3155FB84015C823606188F53B47CB44C444991(_stringLiteralAB3198624EE0C5EF940178C325E58FDC70E514F4, L_11, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_Log_m87A9A3C761FF5C43ED8A53B16190A53D08F818BB(L_12, NULL);
		// if (m_RaycastManager.Raycast(Input.GetTouch(0).position, m_Hits))
		ARRaycastManager_tD9459374F0F5BD9E2E4A8A1C665E7F33F9C2EE44* L_13 = __this->___m_RaycastManager_4;
		...
		List_1_t0754071572EFE7A5C92A59495D2524FC935364E3* L_16 = __this->___m_Hits_5;
		NullCheck(L_13);
		bool L_17;
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_20 = __this->___spawnedObject_8;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_21;
	...
	}
	{
		...
		Ray_t2B1742D7958DC05BDC3EFC7461D3593E1430DC00 L_22 = V_1;
		bool L_23;
		L_23 = Physics_Raycast_mCAC9F02A1AAB49E16B384EBC8318E2DF30F4B0E5(L_22, (&V_0), NULL);
		if (!L_23)
		{
			goto IL_014a;
		}
...
IL_0101:
	...
	{
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_36 = __this->___spawnedObject_8;
		il2cpp_codegen_runtime_class_init_inline(Object_tC12DECB6760A7F2CBF65D9DCF18D044C2D97152C_il2cpp_TypeInfo_var);
		bool L_37;
	...
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_38 = __this->___spawnedObject_8;
		NullCheck(L_38);
		...
		L_42 = ARRaycastHit_get_pose_m84C13E71E21FE12CBA9AAD98DC28B1E414C9EFFD((&V_4), NULL);
